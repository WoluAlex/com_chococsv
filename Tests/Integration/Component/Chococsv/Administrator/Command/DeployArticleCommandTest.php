...
namespace Tests\Integration\Component\Chococsv\Administrator\Command;
...
use Tests\Integration\Component\Chococsv\Administrator\AdministratorIntegrationTestCase;
...
// If enabled, this will create a output.json file
    ...
    public function testTestEndpointWithEmptyValues()
    {
        ...
        //When
        DeployArticleCommand::testEndpoint($givenBaseUrl, $givenBasePath, $givenResourceId);
    }
